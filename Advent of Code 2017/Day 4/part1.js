/**
 * Determines whether a passphrase is valid, i.e. has no duplicated words
...
var isValidPassphrase = function(passphrase) {
	...
	for(var i = 0; i < wordsArray.length && !foundDuplicate; i++)
		for(var j = i + 1; j < wordsArray.length && !foundDuplicate; j++)
 ...
 */
(function() {
	if(!isValidPassphrase("aa bb cc dd ee"))
		throw "Failed test 1";

	if(isValidPassphrase("aa bb cc dd aa"))
		throw "Failed test 2";
	
	if(!isValidPassphrase("aa bb cc dd aaa"))
		throw "Failed test 3";
})();
