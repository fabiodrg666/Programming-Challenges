...
var input = `4168	3925	858	2203	440	185	2886	160	1811	4272	4333	2180	174	157	361	1555
...
/**
 * Parses the string by spliting it by newlines, thus getting a row
 * The row is then split by tabs
 * Each string in the array is converted to number and the search for maximum and minimum is manual
 */
var calcChecksum1 = function () {
	var checksum = 0;
...
/**
 * This approach is similar, but it uses Math.max and Math.min alongside apply() function call. 
 * It has the additional expense of creating an array
 */
var calcChecksum2 = function () {
	var checksum = 0;
